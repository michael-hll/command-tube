...
class Storage():
    ...
    def __init__(self) -> None:
        ...
        self.C_FILE_FULL_NAME          = 'FILE_FULL_NAME'
        self.C_TAIL_LINES              = 'TAIL_LINES'
        self.C_TAIL_KEYWORDS           = 'TAIL_KEYWORDS'
...
def job_start(tube):
    ...
    try:
        ...
        for index, command in enumerate(Storage.I.TUBE_RUN):
            ...
            # except with continue argument value 'True'
